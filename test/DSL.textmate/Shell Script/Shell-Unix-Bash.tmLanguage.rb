...
language 'Shell Script (Bash)' => 'source.shell', file: 'Shell-Unix-Bash' do
  file_types %w(sh bash zsh bashrc bash_profile bash_login profile bash_logout .textmate_init)
