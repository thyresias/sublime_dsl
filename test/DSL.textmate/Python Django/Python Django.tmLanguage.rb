...
language 'Python Django' => 'source.python.django' do
  # FIXME: no file types
  key_equivalent "^~P"  # TextMate only
  uuid "5326D56C-6F76-4758-8DB7-D818527919AC"  # TextMate only

  rule 'support.type.django.model' do
