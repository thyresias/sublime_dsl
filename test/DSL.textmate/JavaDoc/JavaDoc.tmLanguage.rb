...
language 'JavaDoc' => 'text.html.javadoc' do
  ...
  fragment :"inline-formatting" do
    rule 'meta.tag.template.code.javadoc' do
    ...
    rule 'meta.tag.template.literal.javadoc' do
    ...
    rule 'meta.tag.template.docRoot.javadoc' do
      match %r/(\{)((\@)docRoot)(\})/,
        1 => 'punctuation.definition.tag.begin.javadoc',
    ...
    rule 'meta.tag.template.inheritDoc.javadoc' do
      match %r/(\{)((\@)inheritDoc)(\})/,
        1 => 'punctuation.definition.tag.begin.javadoc',
    ...
    rule 'meta.tag.template.link.javadoc' do
    ...
    rule 'meta.tag.template.linkplain.javadoc' do
    ...
    rule 'meta.tag.template.value.javadoc' do
      match %r/(\{)((\@)value)\s*(\S+?)?\s*(\})/,
        1 => 'punctuation.definition.tag.begin.javadoc',
