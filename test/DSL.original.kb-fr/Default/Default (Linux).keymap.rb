...
keymap 'Default (Linux)' do
  ...
  bind 'shift+alt+up', select_lines(forward: false)
  bind 'shift+alt+down', select_lines(forward: true)
  bind 'pageup', move(by: "pages", forward: false)
  bind 'pagedown', move(by: "pages", forward: true)
  bind 'shift+pageup', move(by: "pages", forward: false, extend: true)
  bind 'shift+pagedown', move(by: "pages", forward: true, extend: true)
  ...
  bind 'ctrl+pagedown', next_view
  bind 'ctrl+pageup', prev_view
  ...
  bind 'alt+.', close_tag
  bind 'ctrl+alt+q', toggle_record_macro
  bind 'shift+ctrl+alt+q', run_macro
  ...
  bind 'ctrl+delete', delete_word(forward: true)
  bind 'shift+ctrl+delete', run_macro_file("Packages/Default/Delete to Hard EOL.sublime-macro")
  ...
  bind 'alt+/', auto_complete
  bind 'alt+/', replace_completion_with_auto_complete
    si last_command == "insert_best_completion"
