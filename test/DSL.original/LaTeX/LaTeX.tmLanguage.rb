...
language 'LaTeX' => 'text.tex.latex' do
  ...
  rule 'meta.function.section.latex' do
  ...
  rule 'meta.function.embedded.java.latex' do
    content_scope "source.java.embedded"
    from %r/(?:\s*)((\\)begin)(\{)(lstlisting)(\})(?:(\[).*(\]))?(\s*%\s*(?i:Java)\n?)/
    to %r/((\\)end)(\{)(lstlisting)(\})/
  ...
  rule 'meta.function.embedded.python.latex' do
    ...
    content_scope "source.python.embedded"
    from %r/(?:\s*)((\\)begin)(\{)(lstlisting)(\})(?:(\[).*(\]))?(\s*%\s*(?i:Python)\n?)/
    to %r/((\\)end)(\{)(lstlisting)(\})/
    both 1 => 'support.function.be.latex',
         2 => 'punctuation.definition.function.latex',
         3 => 'punctuation.definition.arguments.begin.latex',
  ...
  rule 'meta.function.embedded.generic.latex' do
    # Put the lstlisting match before the more general environment listing. Someday it would be nice to make this rule general enough to figure out which language is inside the lstlisting environment rather than my own personal use for python. --Brad
    content_scope "source.generic.embedded"
    from %r/(?:\s*)((\\)begin)(\{)(lstlisting)(\})(?:(\[).*(\]))?(\s*%.*\n?)?/
    to %r/((\\)end)(\{)(lstlisting)(\})/
    both 1 => 'support.function.be.latex',
         2 => 'punctuation.definition.function.latex',
         3 => 'punctuation.definition.arguments.begin.latex',
