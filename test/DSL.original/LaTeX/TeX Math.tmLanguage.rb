...
language 'TeX Math' => 'text.tex.math' do
  # FIXME: no file types
  folding_start_marker %r'/\*\*|\{\s*$'
  folding_stop_marker %r'\*\*/|^\s*\}'
  uuid "027D6AF4-E9D3-4250-82A1-8A42EEFE4F76"  # TextMate only
  ...
  rule 'meta.function.sexpr.math.tex' do
    content_scope "source.r.embedded.math.tex"
    from %r/((\\)Sexpr)(\{)/,
