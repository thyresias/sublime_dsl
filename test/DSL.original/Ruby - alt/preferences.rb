...
preferences 'Symbol List: Method' => 'source.ruby meta.function', file: 'Symbo List%3A Method' do
  show_in_symbol_list true
  symbol_transformation 's/^\s*def\s+//'
  uuid "92E190C9-A861-4025-92D4-D6B5A24C22D4"
end

preferences 'Symbol List: No Function Call' => 'source.ruby meta.function-call entity.name.function', file: 'Symbol List%3A No Function Call' do
