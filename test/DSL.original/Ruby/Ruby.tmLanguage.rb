...
language 'Ruby' => 'source.ruby' do
  ...
  rule 'string.unquoted.embedded.html.ruby' do
  ...
  rule 'string.unquoted.embedded.sql.ruby' do
  ...
  rule 'string.unquoted.embedded.css.ruby' do
  ...
  rule 'string.unquoted.embedded.cplusplus.ruby' do
  ...
  rule 'string.unquoted.embedded.c.ruby' do
    # heredoc with embedded c++ and intented terminator
    content_scope "text.c.embedded.ruby"
    # FIXME: (warning) character class has duplicated range
    from %r/(?><<-("?)((?:[_\w]+_|)C)\b\1)/,
  ...
  rule 'string.unquoted.embedded.js.ruby' do
  ...
  rule 'string.unquoted.embedded.js.jquery.ruby' do
    # heredoc with embedded javascript and intented terminator
  ...
  rule 'string.unquoted.embedded.shell.ruby' do
  ...
  rule 'string.unquoted.embedded.ruby.ruby' do
